...
const Register = () => {
    ...
    return (
        <div className='bg-[#c2d0d9] w-full px-4 lg:px-0 h-full py-20'>
            ...
            <div className="animate__animated animate__zoomIn mx-auto lg:w-[400px] bg-white rounded-3xl px-12 pb-6">
                ...
                <form onSubmit={handleRegisterWithEmail}>
                    ...
                    <div className="flex flex-col relative">
                        ...
                        <span onClick={() => setShowPassword(!showPassword)} className="absolute left-[230px] lg:left-[270px] top-2 text-xl">
                            {
