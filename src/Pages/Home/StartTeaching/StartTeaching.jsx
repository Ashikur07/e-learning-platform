...
const StartTeaching = () => {
    return (
        <div className="my-28">
            <h1 className="text-5xl text-center font-semibold pb-10">Start Teaching Now</h1>
            <div className="lg:flex max-w-6xl mx-auto">
                <div className="flex-1">
                    <img className="lg:w-[90%] h-96" src="https://i.ibb.co/MRrqVqW/Improving-teaching-styles.png" alt="" />
                </div>

                <div className="flex-1 lg:mt-12 p-8 lg:p-0">
