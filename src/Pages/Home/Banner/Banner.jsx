...
const Banner = () => {
  ...
  const slides = [
    {
      image:
        "https://i.ibb.co/zZN064Z/photo-1610552254576-9500a3e99999-q-80-w-1434-auto-format-fit-crop-ixlib-rb-4-0.jpg",
      title: "Learn at Home",
    ...
    {
      image:
        "https://i.ibb.co/KVtrH6r/photo-1488190211105-8b0e65b80b4e-q-80-w-1470-auto-format-fit-crop-ixlib-rb-4-0.jpg",
    ...
    {
      image:
        "https://i.ibb.co/m9nfMvS/photo-1629360021730-3d258452c425-q-80-w-1470-auto-format-fit-crop-ixlib-rb-4-0.jpg",
          ...
          <SwiperSlide key={index}>
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-t from-black/95 via-black/40 to-black/20 lg:bg-gradient-to-r lg:from-black/90 lg:via-black/30 lg:to-transparent flex items-end lg:items-center">
                <motion.div
                  className="w-full container mx-auto px-6 md:px-12 lg:px-24 pb-12 lg:pb-0"
                  variants={staggerContainer}
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: false, amount: 0.3 }} // Re-triggers when 30% is visible
                >
                  <div className="max-w-4xl space-y-4 lg:space-y-8">
                    {/* Tag */}
                    <motion.div
                      variants={fadeInUp}
                      className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/10 backdrop-blur-md border border-primary/20"
                    >
                    ...
                    <motion.p
                      variants={fadeInUp}
                      className="text-gray-300 text-sm md:text-lg lg:text-2xl max-w-2xl font-medium leading-relaxed opacity-90"
                    >
                      {slide.desc}
                    </motion.p>
                    ...
                    <motion.div
                      variants={fadeInUp}
                      className="flex flex-row gap-3 md:gap-5 pt-4 lg:pt-6"
                    >
                      <button
                        onClick={() => navigate("/allclasses")}
                        className="flex-1 sm:flex-none px-4 md:px-10 py-3 md:py-4 bg-primary text-white text-xs md:text-base font-extrabold rounded-xl md:rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-lg shadow-primary/30"
                      >
                        Enroll Now
                      </button>
